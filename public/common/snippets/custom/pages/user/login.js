            ...
            form.ajaxSubmit({
                ...
                success: function(response, status, xhr, $form) {
                    if (response.code == 401) {
                        ...
                        window.location.href = '/admin/dashboard?fullname='+response.result.fullname+'&email='+response.result.email;
                    }
                	// similate 30s delay
                	// setTimeout(function() {
                    //     btn.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
        ...
        $('#m_login_signup_submit').click(function(e) {
            ...
            form.ajaxSubmit({
                ...
                success: function(response, status, xhr, $form) {
                	...
                	// setTimeout(function() {
	                //     btn.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
	                //     showErrorMsg(signInForm, 'success', 'danger', 'Network not response. Please try again later.');
	                // }, 30000);
                },
                error: function(data){
                    btn.removeClass('m-loader m-loader--right m-loader--light').attr('disabled', false);
